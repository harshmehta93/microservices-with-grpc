...
public final class HealthServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.demo.hms.grpc.HealthMetrics,
      com.demo.hms.grpc.HealthMetricsResponse> METHOD_SEND_HEALTH_METRICS =
      io.grpc.MethodDescriptor.<com.demo.hms.grpc.HealthMetrics, com.demo.hms.grpc.HealthMetricsResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "HealthService", "sendHealthMetrics"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.demo.hms.grpc.HealthMetrics.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.demo.hms.grpc.HealthMetricsResponse.getDefaultInstance()))
  ...
  public static abstract class HealthServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendHealthMetrics(com.demo.hms.grpc.HealthMetrics request,
        io.grpc.stub.StreamObserver<com.demo.hms.grpc.HealthMetricsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demo.hms.grpc.HealthMetrics,
                com.demo.hms.grpc.HealthMetricsResponse>(
  ...
  public static final class HealthServiceBlockingStub extends io.grpc.stub.AbstractStub<HealthServiceBlockingStub> {
    ...
    /**
     */
    public com.demo.hms.grpc.HealthMetricsResponse sendHealthMetrics(com.demo.hms.grpc.HealthMetrics request) {
  ...
  public static final class HealthServiceFutureStub extends io.grpc.stub.AbstractStub<HealthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.hms.grpc.HealthMetricsResponse> sendHealthMetrics(
        com.demo.hms.grpc.HealthMetrics request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_HEALTH_METRICS:
          serviceImpl.sendHealthMetrics((com.demo.hms.grpc.HealthMetrics) request,
              (io.grpc.stub.StreamObserver<com.demo.hms.grpc.HealthMetricsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.hms.grpc.HMSService.getDescriptor();
    }
